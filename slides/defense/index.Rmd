...
```{r, readDemo, echo=FALSE, cache=FALSE}
# read data
demoData <- read.csv("../../experiments/0_demoQuest/data/demoData.csv", header = TRUE, quote = "\"")
```

```{r, mapload, echo=FALSE, message=FALSE, cache=FALSE}
library(knitr); library(dplyr); library(lingStuff); 
library(ggplot2); library(tidyr); library(pander)
library(leaflet); library(DT)
read_chunk("../../experiments/0_demoQuest/src/1_plot.R")
```
...
```{r, 'mapParticipants', echo=FALSE, warning=FALSE,cache=FALSE,results='asis'}
cat('<iframe src="../../experiments/0_demoQuest/graphs/participantsMap.html" width=100% height=100% allowtransparency="true"> </iframe>')
```
...
<!-- <div style="float:right">
  <img width="400" src="./assets/img/praat.png">
</div> -->
...
<div style="float:right">
  ...
  <img width="250" src="./assets/img/pronunciation.png">
</div>
...
<div style="float:right">
  <img width="50" src="./assets/img/fill.png">
  <img width="250" src="./assets/img/0_name1.png"> </br>
...
<div style="float:right">
  <img width="50" src="./assets/img/fill.png">
  <img width="200" src="./assets/img/2_picture3.png"> </br>
  </br><img width="50" src="./assets/img/fill.png">
  <img width="200" src="./assets/img/2_picture4.png"> </br>
  </br><img width="50" src="./assets/img/fill.png">
  <img width="200" src="./assets/img/2_picture2.png">
</div>
...
<!-- <div style="float:right">
  ...
  <img width="50" src="./assets/img/fill.png">
  <img width="200" src="./assets/img/percepcion.png">
</div>
 -->
...
```{r, 'load', echo=FALSE}
# read data
perc1 <- read.csv("../../experiments/2_2afc/data/perc1.csv", header = TRUE, quote = "")
```


```{r, 'read', echo=FALSE, message=FALSE}
library(knitr); library(dplyr); library(lingStuff); 
library(ggplot2); library(tidyr); library(DT); library(gridExtra)
read_chunk("../../experiments/2_2afc/src/1_2afc_1_plots.R")
read_chunk("../../experiments/2_2afc/src/2_2afc_1_analysis.R")
```
...
<div style="float:right">
  ...
  <img width="60" height="1" src="./assets/img/fill.png">
  <img width="250" src="./assets/img/3_2afcA2.png"></br></br>
  <img width="60" height="1" src="./assets/img/fill.png">
...
```{r, 'modFixed', echo=FALSE, results='asis'}
```

---

```{r, 'plot', fig.height=9, fig.width=14, echo=FALSE, fig.align='center'}
```

---

```{r, 'plotGG', fig.height=9, fig.width=14, echo=FALSE, fig.align='center', warning=FALSE, message=FALSE}
```

---

```{r, 'ggProp', fig.height=9, fig.width=14, echo=FALSE, fig.align='center', warning=FALSE, message=FALSE}
```
...
```{r, 'propTable', echo=FALSE, warning=FALSE,cache=FALSE,results='asis'}
cat('<iframe src="../../experiments/2_2afc/graphs/prop1DT.html" width=100% height=20% allowtransparency="true"> </iframe>')
```
...
```{r, means, echo=FALSE}
perc1 %>%
  filter(., session == 0 | session == 7) %>%
  aggregate(response ~ session, data = ., FUN = mean) -> means
```

- /pa/ responses varied as a function session (F(,) = XXX; p < XXX)
	- Session 0: `r round(means[1, 2], 3)`  
	- Session 7: `r round(means[2, 2], 3)`  

```{r, 'secProp0', fig.height=5, fig.width=7, echo=FALSE, fig.align='right'}
```
...
```{r, 'secProp10', fig.height=6, fig.width=14, echo=FALSE, fig.align='center'}
```
...
```{r, '2afc1CROSS', echo=FALSE, results='hide', message=FALSE, warning=FALSE}
```

```{r, '2afc1CROSSPLOT', fig.height=6, fig.width=8, echo=FALSE, fig.align='right'}
```
...
```{r, 'load2', echo=FALSE}
# read data
perc2 <- read.csv("../../experiments/2_2afc/data/perc2.csv", header = TRUE, quote = "")
```


```{r, 'read2', echo=FALSE, message=FALSE}
read_chunk("../../experiments/2_2afc/src/1_2afc_2_plots.R")
```
...
```{r, 'plotPerc21', fig.height=9, fig.width=14, echo=FALSE, fig.align='center'}
```

---


```{r, 'ggProp2', fig.height=9, fig.width=14, echo=FALSE, fig.align='center', warning=FALSE, message=FALSE}
```
